...
public class DeepSeekClient {
    ...
    /**
     * 非流式单轮调用，用于 Agent 循环：传入完整 messages，返回 assistant 的完整 content。
     */
    public String chatCompletionNonStream(List<Map<String, String>> messages) {
        ...
        try {
            ...
            logger.error("解析非流式响应失败: {}", e.getMessage(), e);
            return "";
        }
    }
